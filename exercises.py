...
def example_list_function():
    example_list= ['cherries', 'apples', 'strawberries']
...
def manage_students():
# your code here
    students= ['Mark', 'Dayana', 'Betty']
    first_student= 'Dayana'
    last_student= 'Betty'
...
def combine_foods():
# your code here
    foods= ('chicken','burger','pizza')
    meal= ' '
    for food in foods:
        meal+= food #concatenate each food to a meal, remm tuples are immutable you cant append to them
    return meal
